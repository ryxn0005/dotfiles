...
static const char *fonts[]                 = {"JetBrainsMono Nerd Font:style=Bold:size=16", "Apple Color Emoji:size=16"};
...
static const Key keys[] = {
	...
	{ 0, XKB_KEY_XF86AudioRaiseVolume,   spawn, SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 10%+") },
